...
Non la valeur des constantes n'a pas d'importance, on retrouve la même chose
...
```{r}
load("C:/Users/isali/OneDrive/Documents/cours/M1 ECAP/S2/Séries temporelles/GDP-US-1990-2023.RData")
```
...
Ici aussi nous ne pouvons pas rejetter pas l’hypothèse de racine unitaire.
